...
<a href="home.php">BACK TO HOME</a>
		...
		<table align = "center" style="background-color: purple" border="1" width="70%">
			<tr>
				...
				<td>
                    <br/> <br/>
                <h1 align= "center"  style="color:red"> <b> Amount Of Remaining Fund  = $5985.6 </b> </h1>
                <br/> <br/>

                <center> <img src="../asset/rfund.png" width="500px" height= "500px"> </center>
                <br/> <br/>
